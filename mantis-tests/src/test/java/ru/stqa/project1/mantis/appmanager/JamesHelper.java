...
public class JamesHelper {
    ...
    public void connectUserToEmail(String user, String email) {
        initTelnetSession();
        write("setforwarding " + user + " " + email);
        String result = readUntil("Forwarding destination for " + user + " set to: " + email);
        closeTelnetSession();
    }
